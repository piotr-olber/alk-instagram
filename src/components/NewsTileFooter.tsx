    ...
    <View style={styles.tileFooter}>
      <View style={styles.tileFooterIconsContainer}>
        <View style={styles.tileFooterIcons}>
          <Pressable
            onPress={() => console.log(`Press hart on tile with id ${id}`)}
          >
            <AntDesign
              name="hearto"
              size={20}
          ...
          <Pressable
            onPress={() => console.log(`Press chat on tile with id ${id}`)}
          >
            <Ionicons
          ...
          <Pressable
            onPress={() => console.log(`Press arrow on tile with id ${id}`)}
          >
            <Entypo
              name="direction"
              size={20}
        ...
        <View style={styles.tileFooterIcons}>
          <Pressable
            onPress={() => console.log(`Press bookmark on tile with id ${id}`)}
          >
            <Ionicons
